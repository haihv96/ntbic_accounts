            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a id="create" class="btn sbold green btn-outline" href="{{route('roles.create', ['source' => $source])}}"><span class="fa fa-pencil"></span> Create Role</a>
                            </div>
                        </div>    
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach($roles as $key => $item)
                            <tr class="odd gradeX">
                                ...
                                <td class="center"><div ><a class='edit' href="{{route('roles.edit', ['source' => $source, 'id' => $item->id])}}" data-id="{{$item->id}}"><span class="fa fa-pencil-square"></span></a></div></td>
