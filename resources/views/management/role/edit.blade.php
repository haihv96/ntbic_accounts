    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{{route('roles.update', ['source' => $source, 'id' => $role->id])}}" method="POST" id="editForm" class="form-horizontal">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="name" data-required="1" class="form-control" value="{{$role->name}}" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible="1" data-rail-color="white" data-handle-color="gray">
                                <div class="icheck-list">
                                    @foreach($permissions as $item)
                                        @if($role->hasPermissionTo($role->source, $item))
